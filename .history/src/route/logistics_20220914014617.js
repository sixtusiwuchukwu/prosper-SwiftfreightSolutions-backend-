...
import generateInvoice from "../utills/generateInvoice.js";
...
router.post("/createqoute", async (req, res) => {
  ...
  let invoicePayload = {
    user: saved.email.split("@")[0],
    trackId,
    pickUp: saved.pickUp,
    dropOff: saved.dropOff,
    cargoType: saved.mode,
  };
 let attachement = await generateInvoice.createInvoice(invoicePayload);
console.log("attaach ==========================",attachement)
